...
import { Input, Label, FormFeedback, Spinner , Col ,  Container, Row , Card , CardBody} from "reactstrap";
          ...
          >
            ...
            <div className="mb-3">
              ...
              <div className="input-group auth-pass-inputgroup">
                ...
                <button
                  ...
                  id="password-addon"
                >
                  <i className={`mdi mdi-eye${oldPasswordShow ? "-off" : ""}`}></i>
                </button>
              </div>
              {validation.touched.oldPassword && validation.errors.oldPassword ? (
            ...
            <div className="mb-3">
              ...
              <div className="input-group auth-pass-inputgroup">
                ...
                <button
                  ...
                  id="password-addon"
                >
                  <i className={`mdi mdi-eye${newPasswordShow ? "-off" : ""}`}></i>
                </button>
              </div>
            ...
            <div className="mb-3">
              ...
              <div className="input-group auth-pass-inputgroup">
                ...
                >
                  <i
                    className={`mdi mdi-eye${confirmPasswordShow ? "-off" : ""}`}
                  ></i>
                </button>
              </div>
